...
class AdminController extends Controller
{
    ...
    public function invoice_approve(Request $req, $id)
    {
        ...
        $details = [
            'title' => 'Mail from FoodHub Admin',
            'body' => 'Your order approved by FoodHub.Your order Invoice no - ' . $id . ' & Delivery Time (approximately) - ' . $req->time,
        ];
        ...
        if ($status != "approve") {
            ...
            $details = [
                'title' => 'Mail from FoodHub Admin',
                'body' => 'Your order approved by FoodHub.Your order Invoice no - ' . $id . ' & Delivery Remaining Time (approximately) - ' . $req->time,
            ];
    ...
    public function invoice_cancel($id)
    {
        ...
        if ($pay_method == "Online Payment") {
            ...
            $details = [
                'title' => 'Mail from FoodHub Admin',
                'body' => 'Sorry Sir.Your order cancelled by FoodHub for inevitable reason.You will get your money back within 8 working days..Your order Invoice no - ' . $id,
            ];
        } else {
            ...
            $details = [
                'title' => 'Mail from FoodHub Admin',
                'body' => 'Sorry Sir.Your order cancelled by FoodHub for inevitable reason.Your order Invoice no - ' . $id,
            ];
        }
        $user = DB::table('users')->where('id', $user_id)->first();
    ...
    public function invoice_complete($id)
    {
        ...
        $details = [
            'title' => 'Mail from FoodHub Admin',
            'body' => 'Your order delivered by FoodHub.Your order Invoice no - ' . $id,
        ];
    ...
    public function add_admin_process(Request $req)
    {
        ...
        $details = [
            'title' => 'Mail from FoodHub Admin',
            'body' => 'Congrats ! You are selected as a ' . $usertype . ' ( Salary - ' . $req->salary . 'Tk ) of FoodHub by FoodHub Admin Panel. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function delete_admin($id)
    {
        ...
        $details = [
            'title' => 'Mail from FoodHub Admin',
            'body' => 'Sorry ! You have been fired from your job by FoodHub Admin Panel.So, your account is deleted by FoodHub Admin Panel.',
        ];
    ...
    public function edit_admin_process(Request $req, $id)
    {
        ...
        if ($update) {
            $details = [
                'title' => 'Mail from FoodHub Admin',
                'body' => 'Congrats ! Your information is updated by FoodHub Admin Panel.',
            ];
            ...
            if (($req->salary != NULL && $req->salary > $previous_salary) || ($req->type != NULL && $req->type < $previous_position)) {
                ...
                $details = [
                    'title' => 'Mail from FoodHub Admin',
                    'body' => 'Congrats ! You are promoted for a ' . $usertype . ' position. ( Now, Your salary - ' . $req->salary . 'Tk ) of FoodHub by FoodHub Admin Panel.',
                ];
                ...
                $details = [
                    'title' => 'Mail from FoodHub Admin',
                    'body' => 'Sorry ! You are depromoted for a ' . $usertype . ' position. ( Now, Your salary - ' . $req->salary . 'Tk ) of FoodHub by FoodHub Admin Panel.',
                ];
            }
    ...
    public function add_delivery_boy_process(Request $req)
    {
        ...
        $details = [
            'title' => 'Mail from FoodHub Admin',
            'body' => 'Congrats ! You are selected as a Delivery Boy position ( Salary - ' . $req->salary . 'Tk ) of FoodHub by FoodHub Admin Panel. Your Email ID - ' . $req->email . ' & Password - ' . $req->password,
        ];
    ...
    public function edit_delivery_boy_process(Request $req, $id)
    {
        ...
        if ($update) {
            ...
            if (($req->salary != NULL && $req->salary > $previous_salary)) {
                $details = [
                    'title' => 'Mail from FoodHub Admin',
                    'body' => 'Congrats ! You are promoted for a  Delivery Boy position. ( Now, Your salary - ' . $req->salary . 'Tk ) of FoodHub by FoodHub Admin Panel.',
                ];
                ...
                $details = [
                    'title' => 'Mail from FoodHub Admin',
                    'body' => 'Sorry ! You are de-promoted for a  Delivery Boy position. ( Now, Your salary - ' . $req->salary . 'Tk ) of FoodHub by FoodHub Admin Panel.',
                ];
            }
            \Mail::to($req->email)->send(new \App\Mail\UserAddedMail($details));
    ...
    public function add_coupon_process(Request $req)
    {
        ...
        $data['code'] = $req->code;
        $data['validate'] = $req->validation_date;
