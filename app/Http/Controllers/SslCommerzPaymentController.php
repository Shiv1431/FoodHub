...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['ship_add1'] = "Lucknow";
        $post_data['ship_add2'] = "Lucknow";
        $post_data['ship_city'] = "Lucknow";
        $post_data['ship_state'] = "UP";
        $post_data['ship_postcode'] = "1000";
        $post_data['ship_phone'] = "";
        $post_data['ship_country'] = "Russia";
    ...
    public function payViaAjax(Request $request)
    {
        ...
        # SHIPMENT INFORMATION
        $post_data['ship_name'] = "Store Test";
        $post_data['ship_add1'] = "Delhi";
        $post_data['ship_add2'] = "Delhi";
        $post_data['ship_city'] = "Delhi";
        $post_data['ship_state'] = "Delhi";
        $post_data['ship_postcode'] = "1000";
        $post_data['ship_phone'] = "";
    ...
    public function success(Request $request)
    {
        ...
        */
        ...
        $qrcode = base64_encode(QrCode::format('svg')->size(100)->errorCorrection('H')->generate('FoodHub Verified'));
        $pdf = PDF::loadView('mails.PayConfirmMail', $data);

        Session::put('qrcode', $qrcode);

        $data['title'] = 'Mail from FoodHub Admin';
