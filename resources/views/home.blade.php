                ...
                <div class="item">
                    ...
                    <div class='card' style=" background-image: url({{asset('assets/images/'.$img)}})">
                        <div class="price">
                            ...
                            <h4 style="background-color:grey">Out Of Stock</h4>
                            @endif
                        </div>
                        <?php
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="left-text-content">
                    ...
                    <p>Members of FoodHub Dine are always active to response your call.</p>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="phone">
                                <i class="fa fa-phone"></i>
                                <h4>Phone Numbers</h4>
                                <span><a href="#">9260932028</a>
                                    <br><a href="#">7380562028</a>
                                </span>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="message">
                                ...
                                <h4>Emails</h4>
                                <span><a href="mailto:shivsingh1309@gmail.com">shivsingh1309@gmail.com</a><br>
                                    <a href="mailto:shivthakur@gmail.com">shivthakur@gmail.com</a><br>
                                </span>
                            </div>
                        </div>
                    </div>
